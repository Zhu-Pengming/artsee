...
export const SalonDetailView = ({ event, onBack }: SalonDetailViewProps) => {
  const highlights = [
    { icon: <GlassWater size={20} />, title: '顶层奢华酒廊', desc: '在城市天际线之上，尊享主理人调制的艺术主题特饮。' },
    { icon: <Music size={20} />, title: '沉浸式大提琴演奏', desc: '特邀交响乐团首席，为您呈现跨越古典与现代的听觉盛宴。' },
    { icon: <Utensils size={20} />, title: '五星级定制私宴', desc: 'W 酒店行政主厨亲撰菜单，将食材之美转化为视觉与味觉的双重艺术。' },
  ];
      ...
      <section className="relative h-[70vh] w-full overflow-hidden">
        ...
        <div className="absolute bottom-20 left-8 right-8 max-w-7xl mx-auto space-y-6">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-7xl font-serif font-light text-white italic leading-tight"
          >
            {event.title}
          </motion.h1>
        ...
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-24">
             <section className="space-y-12">
                ...
                <p className="text-2xl md:text-3xl font-serif font-light text-ink leading-relaxed italic">
             ...
             <section className="grid md:grid-cols-3 gap-8">
               {highlights.map((h, i) => (
                 <div key={i} className="p-10 bg-white rounded-[3rem] border border-silver/30 shadow-sm space-y-6 group hover:border-cobalt transition-all">
          ...
          <div className="lg:col-span-4 space-y-10">
            <section className="sticky top-28 bg-white rounded-[3rem] p-10 border border-silver/30 shadow-2xl space-y-10">
               ...
               <button className="w-full h-20 bg-cobalt text-white rounded-2xl text-xs font-bold uppercase tracking-[0.4em] shadow-3xl shadow-cobalt/20 hover:bg-ink transition-all active:scale-95">
                 立即抢占名额
               </button>

               <div className="text-center pt-4">
                 <button className="text-[10px] font-bold text-ink/20 uppercase tracking-widest hover:text-ink transition-colors">
                   了解会员特权
                 </button>
               </div>
            </section>
