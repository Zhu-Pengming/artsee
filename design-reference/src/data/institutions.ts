...
export const INSTITUTIONS_DATA: Record<string, Institution[]> = {
  "中国香港": [
    { id: "hk-1", name: "香港理工大学设计学院", originalName: "PolyU Design", location: "九龙红磡", image: "https://picsum.photos/seed/polyu-hk/800/600", description: "亚洲顶尖设计学院，以创新与实践见长。" },
  ...
  "美国": [
    { id: "us-1", name: "罗德岛设计学院", originalName: "RISD", location: "普罗维登斯", image: "https://picsum.photos/seed/us-risd/800/600", description: "常年位居全美艺术设计类榜首，被誉为‘艺术界的哈佛’。" },
    ...
    { id: "us-4", name: "帕森斯设计学院", originalName: "Parsons School of Design", location: "纽约", image: "https://picsum.photos/seed/us-parsons/800/600", description: "时尚界的摇篮，服装设计全球领先。" },
  ...
  "欧洲": [
    { id: "eu-1", name: "皇家艺术学院", originalName: "Royal College of Art (RCA)", location: "伦敦, 英国", image: "https://picsum.photos/seed/eu-rca/800/600", description: "全球唯一的全研究制艺术研究生院校，QS世界排名长期第一。" },
    { id: "eu-2", name: "中央圣马丁学院", originalName: "Central Saint Martins", location: "伦敦, 英国", image: "https://picsum.photos/seed/eu-csm/800/600", description: "跨界创意的代名词，时尚与当代艺术的实验田。" },
