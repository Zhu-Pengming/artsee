...
export const DiscoverDetailView: React.FC<DiscoverDetailViewProps> = ({ item }) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <aside className="lg:col-span-4 space-y-8">
              <div className="bg-white p-10 rounded-[3rem] border border-silver/40 text-center space-y-6">
                ...
                <button className="w-full py-5 bg-ink text-white rounded-3xl text-sm font-black uppercase tracking-[0.3em] hover:bg-cobalt transition-all shadow-xl active:scale-95">
                  立即申请 (APPLY NOW)
                </button>
      ...
      return (
        <div className="space-y-10">
          ...
          <div className="aspect-[21/9] rounded-[4rem] overflow-hidden border border-silver/40 shadow-2xl relative group">
            <img src="https://picsum.photos/seed/exhdetail/1600/900" className="w-full h-full object-cover grayscale transition-all duration-1000 group-hover:scale-105 group-hover:grayscale-0" alt="" />
        ...
        <div className="space-y-10">
          <header className="flex justify-between items-start">
            <div className="flex gap-8 items-center">
               <img src={`https://picsum.photos/seed/${item.name}/300/300`} className="w-24 h-24 rounded-full border-4 border-white shadow-xl object-cover grayscale" referrerPolicy="no-referrer" alt="" />
               <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                   {[1, 2, 3, 4].map(i => (
                     <div key={i} className="aspect-square rounded-[3rem] overflow-hidden border border-silver/40 group relative cursor-pointer">
                        <img src={`https://picsum.photos/seed/artistart${i}/800/800`} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700 group-hover:scale-105" referrerPolicy="no-referrer" alt="" />
                     </div>
                   ))}
                </div>
