            ...
            {filteredSchools.map((school, idx) => (
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden">
                  <img src={school.image} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700" referrerPolicy="no-referrer" alt="" />
