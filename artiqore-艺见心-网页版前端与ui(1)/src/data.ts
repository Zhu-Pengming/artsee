...
export const MOCK_POSTS: Post[] = [
  ...
  {
    id: '5',
    author: { name: 'VOGUE Art', avatar: 'https://i.pravatar.cc/150?u=vogue', type: '机构' },
  ...
  {
    id: '6',
    author: { name: '索卡艺术', avatar: 'https://i.pravatar.cc/150?u=soka', type: '画廊' },
  ...
  {
    id: '7',
    author: { name: '林清越', avatar: 'https://i.pravatar.cc/150?u=lin', type: '新锐艺术家' },
  ...
  {
    id: '8',
    author: { name: 'Hermès Art Lab', avatar: 'https://i.pravatar.cc/150?u=hermes', type: '品牌' },
  ...
  {
    id: '9',
    author: { name: 'UCCA', avatar: 'https://i.pravatar.cc/150?u=ucca', type: '机构' },
  ...
  {
    id: '10',
    author: { name: '木木美术馆', avatar: 'https://i.pravatar.cc/150?u=m_woods', type: '机构' },
  ...
  {
    id: '12',
    author: { name: 'A-Z Gallery', avatar: 'https://i.pravatar.cc/150?u=az_gallery', type: '画廊' },
  ...
  {
    id: '13',
    author: { name: '叶子', avatar: 'https://i.pravatar.cc/150?u=ye', type: '自由插画师' },
  ...
  {
    id: '14',
    author: { name: 'PRADA Mode', avatar: 'https://i.pravatar.cc/150?u=prada', type: '品牌' },
  ...
  {
    id: '15',
    author: { name: '实验艺术委员会', avatar: 'https://i.pravatar.cc/150?u=exp', type: '机构' },
